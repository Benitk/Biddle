...
public class StarProductsCustomerActivity extends AppCompatActivity {
    ...
    private DatabaseReference refFavoritesProduct;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star_products_customer);
        ...
        refFavoritesProduct = database.getReference().child("Users").child(userId).child("favoriteProducts");
    ...
    // this method is getting all user favorite product keys from user root and retrive all of them from product root
    private void ReadKeysFromDB(){

        progressb.setVisibility(View.VISIBLE);


        refFavoritesProduct.addValueEventListener(new ValueEventListener() {
